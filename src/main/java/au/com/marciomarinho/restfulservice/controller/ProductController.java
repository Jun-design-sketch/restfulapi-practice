package au.com.marciomarinho.restfulservice.controller;


import au.com.marciomarinho.restfulservice.controller.model.ProductID;
import au.com.marciomarinho.restfulservice.model.Product;
...
//    }
    ...
    public List<Product> getAllProducts(){
        ...
        result.add(new Product("2","Product2",new BigDecimal("1022.55")));
        result.add(new Product("3","Product3",new BigDecimal("2000.99")));
